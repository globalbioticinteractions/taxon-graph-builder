...
$(TAXON_CACHE).update:
	...
	cat $(BUILD_DIR)/names_new_corrected.tsv.gz | gunzip | $(NOMER) append globi | grep -P "\t(FBC:FB|FBC:SLB:|INAT_TAXON:|IRMNG:)" | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	...
	cat $(BUILD_DIR)/names_new_corrected.tsv.gz | gunzip | $(NOMER) append wikidata | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	cat $(BUILD_DIR)/names_new_corrected.tsv.gz | gunzip | $(NOMER) append eol | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	cat $(BUILD_DIR)/names_new_corrected.tsv.gz | gunzip | $(NOMER) append wfo | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	cat $(BUILD_DIR)/names_new_corrected.tsv.gz | gunzip | $(NOMER) append plazi | grep "http://treatment.plazi.org" | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	...
	cat $(BUILD_DIR)/term_unresolved_once.tsv | $(NOMER) append gbif-parse | cut -f1,2,4,5 | sort | uniq | gzip > $(BUILD_DIR)/term_unresolved_once_corrected.tsv.gz

	cat $(BUILD_DIR)/term_unresolved_once_corrected.tsv.gz | gunzip | $(NOMER) append --properties=$(NOMER_PROPERTIES_CORRECTED) itis | grep -P "\t(FBC:FB|FBC:SLB:|INAT_TAXON:|IRMNG:)" | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	...
	cat $(BUILD_DIR)/term_unresolved_once_corrected.tsv.gz | gunzip | $(NOMER) append --properties=$(NOMER_PROPERTIES_CORRECTED) plazi | grep "http://treatment.plazi.org" | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	...
	cat $(BUILD_DIR)/term_unresolved_twice.tsv | $(NOMER) append globi-correct | cut -f1,2,4,5 | sort | uniq | gzip > $(BUILD_DIR)/term_unresolved_twice_corrected.tsv.gz

	cat $(BUILD_DIR)/term_unresolved_twice_corrected.tsv.gz | gunzip | $(NOMER) append --properties=$(NOMER_PROPERTIES_CORRECTED) globi | grep -P "\t(FBC:FB|FBC:SLB:|INAT_TAXON:|IRMNG:)" | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
	...
	cat $(BUILD_DIR)/term_unresolved_twice_corrected.tsv.gz | gunzip | $(NOMER) append --properties=$(NOMER_PROPERTIES_CORRECTED) plazi | grep "http://treatment.plazi.org" | gzip >> $(BUILD_DIR)/term_resolved.tsv.gz
